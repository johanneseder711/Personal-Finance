...
def main():
	...
	print("#"*30,total_dvag_value)

	# render overview of account balances
	render_web_data(total_flatex_value=total_flatex_value,absolute_profit=absolute_profit,total_raiffeisen_giro_value = total_raiffeisen_giro_value,total_raiffeisen_creditcard_value=total_raiffeisen_creditcard_value,n26_balance=n26_balance,n26_last_transaction=n26_last_transaction, total_bank99_balance=total_bank99_balance, total_dvag_value=total_dvag_value)
