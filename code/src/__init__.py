...
def main():
	...
	render_web_data(total_flatex_value,absolute_profit,total_raiffeisen_giro_value,total_raiffeisen_creditcard_value,n26_balance,n26_last_transaction, total_bank99_balance)
